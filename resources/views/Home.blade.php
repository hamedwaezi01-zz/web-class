                ...
                <div class="col-md-8">
                    <div class="pushright">
                        <div class="top">
                            ...
                            @else
                                <a id="reg" class="btn btn-default btn-dark" href="{{ Auth::user()->role_id==1 ? '/admin' : '' }}"> <i class="fas fa-user fa-lg"
                ...
                <div class="categorybox">
                    <ul>
                        ...
                        <li><a href="category.html">Electronics</a>
                            <ul>
                                <li><a href="index.html#">iPhone 4S</a></li>
                                <li><a href="index.html#">Samsung Galaxy</a></li>
                                <li><a href="index.html#">MacBook Pro 17"</a></li>
                            </ul>
                        </li>
