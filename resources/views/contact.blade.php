  ...
  <body>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-8">
					<div class="pushright">
						<div class="top">
							<a href="contact.html#" id="reg" class="btn btn-default btn-dark">Login<span>-- Or --</span>Register</a>
							<div class="regwrap">
								<div class="row">
							...
							<div class="srch-wrap">
								<a href="contact.html#" id="srch" class="btn btn-default btn-search"><i class="fa fa-search"></i></a>
							</div>
							<div class="srchwrap">
								<div class="row">
									<div class="col-md-12">
						...
						<div class="navbar-collapse collapse">
							<ul class="nav navbar-nav">
								...
								<li class="dropdown menu-large">
									<a href="contact.html#" class="dropdown-toggle" data-toggle="dropdown">Mega Menu</a>
								...
								<li class="dropdown">
									<a href="contact.html#" class="dropdown-toggle" data-toggle="dropdown">Dropdown <b class="caret"></b></a>
							...
							<table class="table table-condensed popcart-inner">
								<tbody>
									<tr>
										...
										<td>1X</td>
										<td>$138.80</td>
										<td><a href="contact.html"><i class="fa fa-times-circle fa-2x"></i></a></td>
									</tr>
									<tr>
										<td>
										<a href="product.html"><img src="images/dummy-1.png" alt="" class="img-responsive"/></a>
	...
	<div class="container">
		<ul class="small-menu"><!--small-nav -->
			<li><a href="contact.html" class="myacc">My Account</a></li>
			<li><a href="contact.html"  class="myshop">Shopping Chart</a></li>
			<li><a href="contact.html"  class="mycheck">Checkout</a></li>
		</ul><!--small-nav -->
		<div class="clearfix"></div>
		<div class="lines"></div>
	</div>
			...
			<div class="row">
				<div class="col-md-4"><!--footer twitter widget-->
					...
					<ul class="tweets">
						...
						'Simpler Landing' <a href="contact.html#">http://t.co/LbLwldb6 </a>
					...
					<div class="clearfix"></div>
					<a href="contact.html#" class="btn btn-default btn-follow"><i class="fa fa-twitter fa-2x"></i><div>Follow us on twitter</div></a>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-9">
					...
					<div class="f-credit">&copy;All rights reserved by <a href="contact.html#">yoursite.com</a></div>
					<a href="contact.html"><div class="payment visa"></div></a>
					<a href="contact.html"><div class="payment paypal"></div></a>
					<a href="contact.html"><div class="payment mc"></div></a>
					<a href="contact.html"><div class="payment nh"></div></a>
				</div>
				<div class="col-md-3"><!--footer Share-->
					...
					<div class="fsoc">
						...
						<a href="contact.html#" class="fflickr">flickr</a>
						<a href="contact.html#" class="ffeed">feed</a>
						<div class="clearfix"></div>
					</div>
					<div class="clearfix"></div>
				</div><!--footer Share-->
